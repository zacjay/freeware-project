                                ...
                                <ul class="header-notification-area">
                                    ...
                                    <li class="adomx-dropdown col-auto">
                                        ...
                                        <span class="avatar">
                                            ...
                                            <span class="name">Prayas Cops</span>
                                            </span>
                                        </a>
                                        ...
                                        <div class="adomx-dropdown-menu dropdown-menu-user">
                                            <div class="head">
                                                <h5 class="name"><a href="#"> Prayas Cops</a></h5>
                                                <a class="mail" href="#">pc@gmail.com</a>
                                            </div>
                                            <div class="body">
                                                <ul>
                                                    <li><a href="{{url('')}}"><i class="zmdi zmdi-account"></i>Profile</a></li>
                                                    <li><a href=""><i class="zmdi zmdi-account"></i>Password Change</a></li>
                                                </ul>
