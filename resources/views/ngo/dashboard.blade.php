               ...
               <div class="row mbn-30">
               	...
               	<div class="col-xlg-6 col-md-6 col-12 mb-30">
                    <div class="top-report">
                        ...
                        <!-- Head -->
                        <div class="head">
                            <h4>Total Request Received</h4>
                            <a href="{{url('NgoRecRequest')}}" class="view"><i class="zmdi zmdi-eye"></i></a>
                        </div>
                ...
                <div class="col-xlg-6 col-md-6 col-12 mb-30">
                    <div class="top-report">
                        ...
                        <!-- Head -->
                        <div class="head">
                            <h4>Total Response Sent</h4>
                            <a href="{{url('NgoSendResponse')}}" class="view"><i class="zmdi zmdi-eye"></i></a>
                        </div>
