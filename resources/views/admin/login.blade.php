                    ...
                    <div class="header-logo col-auto">
                            ...
                            <div class="login-register-form">
                                ...
                                <form method="post" action="{{url('AdminDashboard')}}">
                                    @csrf
                                    <div class="row">
                                        <div class="col-12 mb-20"><input class="form-control" type="email" placeholder="User Email Id" name="email"></div>
                                       ...
                                       <!--  <div class="col-12 mb-20"><label for="remember" class="adomx-checkbox-2"><input id="remember" type="checkbox"><i class="icon"></i>Remember.</label></div> -->
                                        <div class="col-12">
                                            <div class="row justify-content-between">
                                                <div class="col-auto mb-15"><a href="{{url('RegisterUser')}}">Click here to SignUp</a></div>

                                               
                                            </div>
                                        </div>
                                        <div class="col-12 mt-10"><button class="button button-primary button-outline" type="submit">Login</button></div>
                                    </div>
                                </form>
                            </div>
                        </div>
