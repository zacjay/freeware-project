               ...
               <div class="row mbn-30">
               	...
               	<div class="col-xlg-6 col-md-6 col-12 mb-30">
                    <div class="top-report">
                        ...
                        <!-- Head -->
                        <div class="head">
                            <h4>Total Recieved Request</h4>
                            <a href="{{url('RequestByMarket')}}" class="view"><i class="zmdi zmdi-eye"></i></a>
                        </div>
                ...
                <div class="col-xlg-6 col-md-6 col-12 mb-30">
                    <div class="top-report">
                        ...
                        <!-- Head -->
                        <div class="head">
                            <h4>Total Usres Added</h4>
                            <a href="{{url('UsersList')}}" class="view"><i class="zmdi zmdi-eye"></i></a>
                        </div>
                ...
                <div class="col-xlg-6 col-md-6 col-12 mb-30">
                    <div class="top-report">
                        ...
                        <!-- Head -->
                        <div class="head">
                            <h4>Total Recieved Response</h4>
                            <a href="{{url('ResponseByNgo')}}" class="view"><i class="zmdi zmdi-eye"></i></a>
                        </div>
                ...
                <div class="col-xlg-6 col-md-6 col-12 mb-30">
                    <div class="top-report">
                        ...
                        <div class="head">
                            ...
                            <a href="{{url('PaymentStatus')}}" class="view"><i class="zmdi zmdi-eye"></i></a>
                        </div>
